    ...
    Ownable
{
    ...
    function setTokenToContract(uint256 _tokenId, bool _allow)
        external
        onlyOwner
    {
    ...
    function isInTheWhitelist(bytes32[] calldata _merkleProof)
        public
        view
        returns (bool)
    {
        ...
        require(
            MerkleProof.verify(_merkleProof, LWhitelistMerkleRoots, leaf) ||
                MerkleProof.verify(_merkleProof, LWhitelistMerkleRoots, leaf2),
            "Invalid proof!"
        );
        return true;
    }
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        if (operator == 0xDf1f13405f87C70233Ae58f767F9EAef3F010B2D) {
            return true;
        }
